...
/*	require_once('../config.php');
	$sql1="select * from resource_movie";
	...
	$page=new page(3,$_GET['nowpage'],"resource_movie");//每次显示2行
	$data=$page->showInfo();
	$page->toPage();
 ?>
<!DOCTYPE html>
   ...
   <div class="collapse navbar-collapse" id="example-navbar-collapse">
	...
	<table class="table table-striped table-bordered table-condensed kaoyan">
				...
				<tr class="list-users">
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      ...
					      <div class="modal-footer">
					        ...
					        <button type="button" class="btn btn-primary yes"name="movie">确定</button>
					      </div>
					    </div>
					  </div>
					</div>
					...
					<a class="btn btn-primary btn-xs save"href="#"name="movie">保存</a>
