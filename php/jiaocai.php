...
/*	require_once('../config.php');
	$sql1="select * from resource_study";
	...
	$page=new page(3,$_GET['nowpage'],"resource_study");//每次显示2行
	$data=$page->showInfo();
	$page->toPage();
 ?>
<!DOCTYPE html>
...
<body>
   ...
   <div class="collapse navbar-collapse" id="example-navbar-collapse">
      <ul class="nav navbar-nav">
         ...
         <li class="active"><a href="#">教材</a></li>
         <li><a href="kaoyan.php">软件</a></li>
         <li class="dropdown">
	...
	<table class="table table-striped table-bordered table-condensed kaoyan">
				...
				<tr class="list-users">
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      ...
					      <div class="modal-footer">
					        ...
					        <button type="button" class="btn btn-primary yes"name="study">确定</button>
					      </div>
					    </div>
					  </div>
					</div>
					...
					<a class="btn btn-primary btn-xs save"href="#"name="study">保存</a>
