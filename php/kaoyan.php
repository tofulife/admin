...
/*	require_once('../config.php');
	$sql1="select * from resource_aimgraduate";
	...
	$page=new page(3,$_GET['nowpage'],"resource_aimgraduate");//每次显示2行
	$data=$page->showInfo();
	$page->toPage();
 ?>
<!DOCTYPE html>
...
<body>
   ...
   <div class="collapse navbar-collapse" id="example-navbar-collapse">
      <ul class="nav navbar-nav">
         <li class="active"><a href="kaoyan">考研</a></li>
         <li><a href="dianying.php">电影</a></li>
         <li><a href="jiaocai.php">教材</a></li>
         <li><a href="ruanjian.php">软件</a></li>
         <li class="dropdown">
	...
	<table class="table table-striped table-bordered table-condensed kaoyan">
				...
				<tr class="list-users">
					...
					<td class="operation">
					<a class="btn btn-primary btn-xs edit"name="kaoyan.edit"href="#">修改</a>
					<a class="btn btn-primary btn-xs delete"name=-"kaoyan.delete" data-toggle="modal" data-target="#myModal"href="#">删除</a>
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      ...
					      <div class="modal-footer">
					        ...
					        <button type="button" class="btn btn-primary yes"name="kaoyan">确定</button>
					      </div>
					    </div>
					  </div>
					</div>
					...
					<a class="btn btn-primary btn-xs save"name="kaoyan"href="#">保存</a>
